package com.coalbot.module.camera.media.event.hook;
...
import com.coalbot.module.camera.media.event.media.MediaEvent;
import com.coalbot.module.camera.media.event.media.MediaPublishEvent;
