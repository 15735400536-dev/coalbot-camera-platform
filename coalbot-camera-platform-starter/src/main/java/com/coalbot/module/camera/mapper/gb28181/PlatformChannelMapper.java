...
public interface PlatformChannelMapper {
    ...
    @Select("<script>" +
            ...
            "</script>")
    List<PlatformChannel> queryForPlatformForWebList(@Param("platformId") String platformId, @Param("query") String query,
    ...
    List<CommonGBChannel> queryOneWithPlatform(@Param("platformId") String platformId, @Param("channelDeviceId") String channelDeviceId);
    ...
    @Select(" <script>" +
            ...
            " </script>")
    Set<Group> queryShareGroup(@Param("platformId") String platformId);
