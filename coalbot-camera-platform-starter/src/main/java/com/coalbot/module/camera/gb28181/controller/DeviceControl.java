...
public class DeviceControl {
    ...
    @GetMapping("/record")
    public DeferredResult<RetResult<String>> recordApi(String deviceId, String recordCmdStr, String channelId) {
        if (log.isDebugEnabled()) {
		...
		deferredResult.onTimeout(() -> {
			...
			deferredResult.setResult(RetResponse.makeRsp(ErrorCode.ERROR100.getCode(), "操作超时, 设备未应答"));
		});
	...
	@GetMapping("/guard")
	public DeferredResult<RetResult<String>> guardApi(String deviceId, String guardCmd) {
		if (log.isDebugEnabled()) {
	...
	public DeferredResult<RetResult<String>> resetAlarm(String deviceId, String channelId,
	...
	public DeferredResult<RetResult<String>> homePositionApi(String deviceId, String channelId, Boolean enabled,
	...
	public DeferredResult<RetResult<String>> dragZoomIn(@RequestParam String deviceId, String channelId,
	...
	public DeferredResult<RetResult<String>> dragZoomOut(@RequestParam String deviceId,
