...
public interface ICloudRecordService {
     ...
     * 添加指定录像收藏
     */
    int changeCollectById(String recordId, boolean result);

    /**
     * 获取播放地址
     */
    DownloadFileInfo getPlayUrlPath(String recordId);

    List<CloudRecordItem> getAllList(String query, String app, String stream, String startTime, String endTime, List<MediaServer> mediaServerItems, String callId, List<String> ids);
    ...
    void deleteFileByIds(Set<String> ids);

    void loadMP4File(String app, String stream, String cloudRecordId, ErrorCallback<StreamInfo> callback);

    List<CloudRecordUrl> getUrlListByIds(List<String> ids);
