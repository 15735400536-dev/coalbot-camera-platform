...
public class GbChannelServiceImpl implements IGbChannelService, CommandLineRunner {
    ...
    public int update(CommonGBChannel commonGBChannel) {
        ...
        if (commonGBChannel.getGbId() != null) {
    ...
    @Override
    public CommonGBChannel getOne(String id) {
    ...
    @Override
    @Transactional
    public void deleteChannelToRegion(String civilCode, List<String> channelIds) {
...
//        }
    ...
    @Override
    public CommonGBChannel queryOneWithPlatform(String platformId, String channelDeviceId) {
        // 防止共享的通道编号重复
    ...
    @Override
    public void clearChannelCivilCode(Boolean all, List<String> channelIds) {

        List<String> channelIdsForClear;
        if (all != null && all) {
    ...
    @Override
    public void clearChannelParent(Boolean all, List<String> channelIds) {
        List<String> channelIdsForClear;
        if (all != null && all) {
...
//        });
    ...
    public byte[] getTile(int z, int x, int y, String geoCoordSys) {
        ...
        // TODO java-vector-tile 依赖下载不下来，暂时注释代码
    ...
    public String drawThin(Map<Integer, Double> zoomParam, Extent extent, String geoCoordSys) {
        ...
        dynamicTask.startDelay(id, () -> {
            try {
                ...
                Map<String, CommonGBChannel> useCameraMap = new HashMap<>();
