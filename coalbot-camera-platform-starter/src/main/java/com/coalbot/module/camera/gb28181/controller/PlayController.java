...
public class PlayController {
    ...
    public DeferredResult<RetResult<StreamContent>> play(HttpServletRequest request, @PathVariable String deviceId,
    ...
    public RetResult<Void> stopBroadcast(@PathVariable String deviceId, @PathVariable String channelId) {
        if (log.isDebugEnabled()) {
    ...
    public DeferredResult<String> getSnap(String deviceId, String channelId) {
        ...
        playService.getSnap(deviceId, channelId, fileName, (code, msg, data) -> {
            if (code == InviteErrorCode.SUCCESS.getCode()) {
                ...
                message.setData(RetResponse.makeRsp(code, msg));
            }
