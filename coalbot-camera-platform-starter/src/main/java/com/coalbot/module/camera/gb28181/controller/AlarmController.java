...
public class AlarmController {
    ...
    public RetResult<Integer> delete(
        ...
        return RetResponse.makeOKRsp(deviceAlarmService.clearAlarmBeforeTime(id, deviceIdList, time));
    }
    ...
    public RetResult<Void> delete(@RequestParam String deviceId) {
