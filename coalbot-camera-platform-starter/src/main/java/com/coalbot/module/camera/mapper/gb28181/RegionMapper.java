...
public interface RegionMapper {
    ...
    @Select(" <script>" +
            ...
            " <foreach collection='channelList'  item='item'  open='(' separator=',' close=')' > #{item.gbCivilCode}</foreach>" +
            " </script>")
    Set<Region> queryNotShareRegionForPlatformByChannelList(List<CommonGBChannel> channelList, @Param("platformId") String platformId);
    ...
    @Select(" <script>" +
            ...
            " </script>")
    Set<Region> queryNotShareRegionForPlatformByRegionList(Set<Region> allRegion, @Param("platformId") String platformId);
