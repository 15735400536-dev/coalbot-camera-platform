package com.coalbot.module.camera.web.custom.conf;
...
//        RetResult.setMsg(message);
        RetResult<Object> RetResult = RetResponse.makeRsp(code, message);
        return JSON.toJSONString(RetResult);
    }
