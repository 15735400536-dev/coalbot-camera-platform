...
import com.coalbot.module.camera.mapper.gb28181.DeviceMobilePositionMapper;
...
import static com.coalbot.module.camera.gb28181.utils.XmlUtil.getText;
...
public class DeviceChannelServiceImpl implements IDeviceChannelService {
    ...
    @Override
    public DeviceChannel getOneForSourceEx(String deviceDbId, String channelId) {
        return channelMapper.getOneByDeviceIdForSource(deviceDbId, channelId);
    }

    @Override
    public DeviceChannel getOneBySourceId(String deviceDbId, String channelId) {
    ...
    @Override
    public List<String> queryChaneIdListByDeviceDbIds(List<String> deviceDbIds) {
        return channelMapper.queryChaneIdListByDeviceDbIds(deviceDbIds);
    }

    @Override
    public void handlePtzCmd(@NotNull String dataDeviceId, @NotNull String gbId, Element rootElement, DeviceControlType type, ErrorCallback<String> callback) {
    ...
    @Override
    public void startPlay(String channelId, String stream) {
        channelMapper.startPlay(channelId, stream);
    }

    @Override
    public void stopPlay(String channelId) {
    ...
    @Override
    @Transactional
    public boolean resetChannels(String deviceDbId, List<DeviceChannel> deviceChannelList) {
    ...
    @Override
    public PageInfo<DeviceChannel> getSubChannels(String deviceDbId, String channelId, String query, Boolean channelType, Boolean online, int page, int count) {
    ...
    @Override
    public DeviceChannel getRawChannel(String id) {
        return deviceMapper.getRawChannel(id);
    }

    @Override
    public DeviceChannel getOneById(String channelId) {
        return channelMapper.getOne(channelId);
    }

    @Override
    public DeviceChannel getOneForSourceById(String channelId) {
        return channelMapper.getOneForSource(channelId);
    }

    @Override
    public DeviceChannel getBroadcastChannel(String deviceDbId) {
    ...
    @Override
    public void changeAudio(String channelId, Boolean audio) {
