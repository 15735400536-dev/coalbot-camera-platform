...
public class PlaybackController {
    ...
    public DeferredResult<RetResult<StreamContent>> start(HttpServletRequest request, @PathVariable String deviceId, @PathVariable String channelId,
    ...
    public RetResult<Void> playStop(
    ...
    public RetResult<Void> playbackPause(@PathVariable String streamId) {
    ...
    public RetResult<Void> playResume(@PathVariable String streamId) {
    ...
    public RetResult<Void> playbackSeek(@PathVariable String streamId, @PathVariable long seekTime) {
