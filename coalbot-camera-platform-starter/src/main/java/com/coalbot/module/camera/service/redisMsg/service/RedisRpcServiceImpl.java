...
public class RedisRpcServiceImpl implements IRedisRpcService {
    ...
    @Override
    public RetResult startSendRtp(String callId, SendRtpInfo sendRtpItem) {
        ...
        RedisRpcResponse response = redisRpcConfig.request(request, 10, TimeUnit.MILLISECONDS);
        return JSON.parseObject(response.getBody().toString(), RetResult.class);
    }

    @Override
    public RetResult stopSendRtp(String callId) {
        SendRtpInfo sendRtpItem = (SendRtpInfo)redisTemplate.opsForValue().get(callId);
        if (sendRtpItem == null) {
            log.info("[请求其他WVP] 停止推流, 未找到redis中的发流信息， key：{}", callId);
            return RetResponse.makeRsp(ErrorCode.ERROR100.getCode(), "未找到发流信息");
        }
    ...
    @Override
    public boolean deletePlatform(String serverId, String platformId) {
    ...
    @Override
    public int removeAllPlatformChannel(String serverId, String platformId) {
    ...
    @Override
    public boolean pushPlatformChannel(String serverId, String platformId) {
    ...
    @Override
    public RetResult<SyncStatus> devicesSync(String serverId, String deviceId) {
    ...
    @Override
    public RetResult<String> deviceBasicConfig(String serverId, Device device, BasicParam basicParam) {
    ...
    @Override
    public RetResult<String> deviceConfigQuery(String serverId, Device device, String channelId, String configType) {
        JSONObject jsonObject = new JSONObject();
    ...
    @Override
    public RetResult<String> recordControl(String serverId, Device device, String channelId, String recordCmdStr) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("device", device.getDeviceId());
        jsonObject.put("channelId", channelId);
    ...
    @Override
    public RetResult<String> guard(String serverId, Device device, String guardCmdStr) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("device", device.getDeviceId());
    ...
    @Override
    public RetResult<String> resetAlarm(String serverId, Device device, String channelId, String alarmMethod, String alarmType) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("device", device.getDeviceId());
        jsonObject.put("channelId", channelId);
    ...
    @Override
    public RetResult<String> homePosition(String serverId, Device device, String channelId, Boolean enabled, Integer resetTime, Integer presetIndex) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("device", device.getDeviceId());
        jsonObject.put("channelId", channelId);
    ...
    @Override
    public RetResult<String> deviceStatus(String serverId, Device device) {
    ...
    @Override
    public RetResult<Object> deviceInfo(String serverId, Device device) {
    ...
    @Override
    public RetResult<List<Preset>> queryPreset(String serverId, Device device, String channelId) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("device", device.getDeviceId());
        jsonObject.put("channelId", channelId);
    ...
    @Override
    public RetResult<String> alarm(String serverId, Device device, String startPriority, String endPriority,
