...
public interface GroupMapper {
    ...
    int updateChild(@Param("parentId") String parentId, Group group);
    ...
    @Select(" <script>" +
            ...
            " </script>")
    Set<Group> queryNotShareGroupForPlatformByChannelList(List<CommonGBChannel> channelList, @Param("platformId") String platformId);
    ...
    @Select(" <script>" +
            ...
            " </script>")
    Set<Group> queryNotShareGroupForPlatformByGroupList(Set<Group> allGroup, @Param("platformId") String platformId);
