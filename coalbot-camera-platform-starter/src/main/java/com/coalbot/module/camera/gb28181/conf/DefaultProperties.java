package com.coalbot.module.camera.gb28181.conf;

import com.coalbot.module.camera.gb28181.transmit.event.request.impl.message.notify.cmd.AlarmNotifyMessageHandler;
...
//        properties.setProperty("javax.sip.IP_ADDRESS", ip);
        ...
        if (sipLog) {
            properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "com.coalbot.module.camera.gb28181.conf.StackLoggerImpl");
            properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "com.coalbot.module.camera.gb28181.conf.ServerLoggerImpl");
