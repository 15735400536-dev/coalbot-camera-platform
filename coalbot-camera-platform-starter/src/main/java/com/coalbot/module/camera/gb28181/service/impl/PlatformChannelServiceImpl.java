...
public class PlatformChannelServiceImpl implements IPlatformChannelService {
    ...
    @Override
    public PageInfo<PlatformChannel> queryChannelList(int page, int count, String query, Integer channelType, Boolean online, String platformId, Boolean hasShare) {
     ...
     */
    @Transactional
    public Set<Group> getGroupNotShareByChannelList(List<CommonGBChannel> channelList, String platformId) {
        // 获取分组中未分享的节点
     ...
     * 获取通道使用的分组中未分享的
     */
    private Set<Region> getRegionNotShareByChannelList(List<CommonGBChannel> channelList, String platformId) {
        // 获取分组中未分享的节点
     ...
     */
    @Transactional
    public Set<Group> deleteEmptyGroup(Set<Group> groupSet, String platformId) {
     ...
     * 移除空的共享，并返回移除的行政区划
     */
    private Set<Region> deleteEmptyRegion(Set<Region> regionSet, String platformId) {
    ...
    public int addChannelList(String platformId, List<CommonGBChannel> channelList) {
        ...
        if (!userSetting.getServerId().equals(platform.getServerId())) {
            ...
            List<String> channelIdList = channelList.stream().map(CommonGBChannel::getGbId).collect(Collectors.toList());
    ...
    @Override
    public int removeAllChannel(String platformId) {
        Platform platform = platformMapper.query(platformId);
        if (platform == null) {
            return 0;
        }
    ...
    @Override
    @Transactional
    public void addChannelByDevice(String platformId, List<String> deviceIds) {
        List<String> channelList = commonGBChannelMapper.queryByGbDeviceIdsForIds(ChannelDataType.GB28181, deviceIds);
        addChannels(platformId, channelList);
    }

    @Override
    @Transactional
    public void removeChannelByDevice(String platformId, List<String> deviceIds) {
        List<String> channelList = commonGBChannelMapper.queryByGbDeviceIdsForIds(ChannelDataType.GB28181, deviceIds);
        removeChannels(platformId, channelList);
    }

    @Transactional
    public int removeChannelList(String platformId, List<CommonGBChannel> channelList) {
        Platform platform = platformMapper.query(platformId);
        if (platform == null) {
        ...
        if (!userSetting.getServerId().equals(platform.getServerId())) {
            List<String> channelIds = channelList.stream().map(CommonGBChannel::getGbId).collect(Collectors.toList());
    ...
    @Override
    @Transactional
    public int removeChannels(String platformId, List<String> channelIds) {
    ...
    @Override
    @Transactional
    public void removeChannels(List<String> ids) {
    ...
    @Override
    public List<Platform> queryPlatFormListByChannelDeviceId(String channelId, List<String> platforms) {
        return platformChannelMapper.queryPlatFormListForGBWithGBId(channelId, platforms);
    }

    @Override
    public CommonGBChannel queryChannelByPlatformIdAndChannelId(String platformId, String channelId) {
        return platformChannelMapper.queryShareChannel(platformId, channelId);
    }

    @Override
    public List<CommonGBChannel> queryChannelByPlatformIdAndChannelIds(String platformId, List<String> channelIds) {
