...
public interface DeviceAlarmMapper {
    ...
    @Insert("INSERT INTO wcp_device_alarm (device_id, channel_id, alarm_priority, alarm_method, alarm_time, alarm_description, longitude, latitude, alarm_type , create_time ) " +
    ...
    @Delete(" <script>" +
            "DELETE FROM wcp_device_alarm WHERE 1=1 " +
