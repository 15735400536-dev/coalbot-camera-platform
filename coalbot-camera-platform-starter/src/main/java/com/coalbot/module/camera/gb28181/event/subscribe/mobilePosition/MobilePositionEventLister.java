package com.coalbot.module.camera.gb28181.event.subscribe.mobilePosition;
...
import com.coalbot.module.camera.gb28181.bean.SubscribeInfo;
...
public class MobilePositionEventLister implements ApplicationListener<MobilePositionEvent> {
    ...
    public void onApplicationEvent(MobilePositionEvent event) {
        if (event.getMobilePosition().getChannelId() == null) {
            return;
        }
