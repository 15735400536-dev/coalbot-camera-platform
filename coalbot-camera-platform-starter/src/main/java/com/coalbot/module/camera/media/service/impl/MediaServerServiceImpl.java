package com.coalbot.module.camera.media.service.impl;
...
import com.coalbot.module.camera.mapper.storager.MediaServerMapper;
...
import com.coalbot.module.camera.media.event.mediaServer.MediaServerDeleteEvent;
...
//        });
        // 新的写法
        result.sort(Comparator.comparing(serverItem -> serverItem.getCreateTime()));
        return result;
    }
    ...
    public void add(MediaServer mediaServer) {
        mediaServer.setCreateTime(new Date());
        mediaServer.setUpdateTime(new Date());
    ...
    public RetResult<String> addStreamProxy(MediaServer mediaServer, String app, String stream, String url,
        ...
        if (mediaNodeServerService == null) {
            ...
            return RetResponse.makeRsp(ErrorCode.ERROR400.getCode(), ErrorCode.ERROR400.getMsg());
        }
