...
public class PtzController {
	...
	public RetResult<Void> frontEndCommand(@PathVariable String deviceId, @PathVariable String channelId, Integer cmdCode, Integer parameter1, Integer parameter2, Integer combindCode2){
	...
	public RetResult<Void> ptz(@PathVariable String deviceId,@PathVariable String channelId, String command, Integer horizonSpeed, Integer verticalSpeed, Integer zoomSpeed){
	...
	public RetResult<Void> iris(@PathVariable String deviceId,@PathVariable String channelId, String command, Integer speed){
	...
	public RetResult<Void> focus(@PathVariable String deviceId,@PathVariable String channelId, String command, Integer speed){
	...
	public DeferredResult<RetResult<Object>> queryPreset(@PathVariable String deviceId, @PathVariable String channelId) {
		if (log.isDebugEnabled()) {
	...
	public RetResult<Void> wiper(@PathVariable String deviceId,@PathVariable String channelId, String command){
	...
	public RetResult<Void> auxiliarySwitch(@PathVariable String deviceId,@PathVariable String channelId, String command, Integer switchId){
