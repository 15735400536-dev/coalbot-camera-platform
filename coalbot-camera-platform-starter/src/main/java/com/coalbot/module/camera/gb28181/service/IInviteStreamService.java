...
public interface IInviteStreamService {
     ...
     * 获取点播的状态信息
     */
    InviteInfo getInviteInfo(InviteSessionType type, String channelId, String stream);

    /**
     * 移除点播的状态信息
     */
    void removeInviteInfo(InviteSessionType type, String channelId, String stream);
    /**
     * 移除点播的状态信息
     */
     ...
     * 移除点播的状态信息
     */
    void removeInviteInfoByDeviceAndChannel(InviteSessionType inviteSessionType, String channelId);
     ...
     * 获取点播的状态信息
     */
    InviteInfo getInviteInfoByDeviceAndChannel(InviteSessionType type, String channelId);
     ...
     * 添加一个invite回调
     */
    void once(InviteSessionType type, String channelId, String stream,  ErrorCallback<StreamInfo> callback);

    /**
     * 调用一个invite回调
     */
    void call(InviteSessionType type,  String channelId, String stream,  int code, String msg, StreamInfo data);
