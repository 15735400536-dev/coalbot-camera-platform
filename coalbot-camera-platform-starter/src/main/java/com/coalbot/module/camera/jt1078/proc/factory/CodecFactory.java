...
public class CodecFactory {
    ...
    public static void init() {
        ...
        List<Class<?>> classList = ClassUtil.getClassList("com.coalbot.module.camera.jt1078.proc", MsgId.class);
