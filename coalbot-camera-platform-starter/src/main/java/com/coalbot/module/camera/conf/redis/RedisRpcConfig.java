package com.coalbot.module.camera.conf.redis;
...
//        List<Class<?>> classList = ClassUtil.getClassList("com.coalbot.module.camera.service.redisMsg.control", RedisRpcController.class);
